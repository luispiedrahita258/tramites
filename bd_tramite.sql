...
-- Tiempo de generación: 24-02-2022 a las 15:43:04
...
--
CREATE DATABASE IF NOT EXISTS `bd_tramite` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `bd_tramite`;
...
DROP PROCEDURE IF EXISTS `PA_EDITARAREA`$$
...
DROP PROCEDURE IF EXISTS `PA_EDITARCIUDADANOTODOS`$$
...
DROP PROCEDURE IF EXISTS `PA_EDITARINSTITUCION`$$
...
DROP PROCEDURE IF EXISTS `PA_EDITARPERSONAL`$$
...
DROP PROCEDURE IF EXISTS `PA_EDITARPERSONALTODOS`$$
...
DROP PROCEDURE IF EXISTS `PA_EDITARTIPODOCUMENTO`$$
...
DROP PROCEDURE IF EXISTS `PA_REGISTRARAREA`$$
...
DROP PROCEDURE IF EXISTS `PA_REGISTRARCIUDADANO`$$
...
DROP PROCEDURE IF EXISTS `PA_REGISTRARDOCUMENTO`$$
...
DROP PROCEDURE IF EXISTS `PA_REGISTRARDOCUMENTOARCHIVO`$$
...
DROP PROCEDURE IF EXISTS `PA_REGISTRARINSTITUCION`$$
...
DROP PROCEDURE IF EXISTS `PA_REGISTRARPERSONAL`$$
...
DROP PROCEDURE IF EXISTS `PA_REGISTRARTIPODOCUMENTO`$$
...
CREATE TABLE IF NOT EXISTS `area` (
  ...
  `area_nombre` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'nombre del area',
...
CREATE TABLE IF NOT EXISTS `ciudadano` (
  `ciudadano_cod` int NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `detalle_ciudadano`;
CREATE TABLE IF NOT EXISTS `detalle_ciudadano` (
  `detalleciudadano_cod` int NOT NULL AUTO_INCREMENT,
  `ciudadano_cod` int NOT NULL,
  `documento_cod` char(13) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `detalle_institucion`;
CREATE TABLE IF NOT EXISTS `detalle_institucion` (
  `detalleinstitucion_cod` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `documento` (
  `documento_cod` char(13) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Codigo auto-incrementado del documento',
  `doc_asunto` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Asunto del documento',
  `doc_fecha_recepcion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'fecha del registro del documento',
  `tipoDocumento_cod` int NOT NULL COMMENT 'codigo del tipo de documentos',
  `area_cod` int NOT NULL COMMENT 'Destino del documento',
  `usu_cod` int NOT NULL COMMENT 'Codigo de Usuario',
  `doc_estado` enum('PENDIENTE','ACEPTADO','RECHAZADO') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'estado del documento',
  `doc_tipo` enum('I','C') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doc_documento` varchar(350) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
(1, 'ARCHIVO', 'GESTIO DOCUMENTAL', 'ACTIVO'),
(2, 'TECNICO 1', 'RECEPCION', 'INACTIVO'),
(3, 'PROFESIONAL 1', 'VERIFICACION', 'ACTIVO');
...
CREATE TABLE IF NOT EXISTS `personal` (
  `personal_cod` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tipo_documento` (
  `tipodocumento_cod` int NOT NULL AUTO_INCREMENT COMMENT 'Codigo auto-incrementado del tipo documento',
